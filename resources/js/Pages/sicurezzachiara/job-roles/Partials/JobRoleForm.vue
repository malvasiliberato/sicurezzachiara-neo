...
<template>
  <BCard no-body>
    <BCardHeader class="border-0">
      <div>
        <h4 class="card-title mb-1">Catalogo mansioni</h4>
        <p class="text-muted mb-0">Base riusabile tenant-level pronta a diventare input del futuro profilo rischio.</p>
      </div>
    </BCardHeader>
    <BCardBody>
      <BRow class="g-3">
        ...
        <BCol md="8">
          <InputLabel for="name" value="Nome mansione *" />
        ...
        <BCol md="4">
          <div class="form-check form-switch form-switch-md mt-2">
            ...
            <label class="form-check-label" for="is_active">Mansione attiva</label>
          </div>
    ...
    <BCardFooter class="bg-white border-top">
      <div class="hstack justify-content-end gap-2">
        <Link :href="route('job-roles.index')" class="btn btn-soft-secondary">Annulla</Link>
