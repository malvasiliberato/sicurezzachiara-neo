...
<template>
  <BCard no-body>
    <BCardHeader class="border-0">
      <div>
        <h4 class="card-title mb-1">Catalogo tipologie macchinario</h4>
        <p class="text-muted mb-0">Base tenant-level riusabile per censire le istanze operative presenti nelle aziende.</p>
      </div>
    </BCardHeader>
    <BCardBody>
      <BRow class="g-3">
        ...
        <BCol md="8">
          <InputLabel for="name" value="Nome tipologia *" />
        ...
        <BCol md="4">
          <div class="form-check form-switch form-switch-md mt-2">
            ...
            <label class="form-check-label" for="is_active">Tipologia attiva</label>
          </div>
    ...
    <BCardFooter class="bg-white border-top">
      <div class="hstack justify-content-end gap-2">
        <Link :href="route('equipment-types.index')" class="btn btn-soft-secondary">Annulla</Link>
